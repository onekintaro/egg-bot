...
module.exports = {
    checkMusic: function (member, bot) {
        ...
        const player = (_a = bot.manager) === null || _a === void 0 ? void 0 : _a.players.get(member.guild.id);
        if (!player)
            return member.guild.translate('misc:NO_QUEUE');
        // Check that user is in the same voice channel
        if (((_c = (_b = member.voice) === null || _b === void 0 ? void 0 : _b.channel) === null || _c === void 0 ? void 0 : _c.id) !== player.voiceChannel)
            return member.guild.translate('misc:NOT_VOICE');
