...
TextChannel.prototype.send = function (...args) {
    ...
    // check permissions
    if (!this.permissionsFor(this.client.user).has(Flags.SendMessages))
        return;
        ...
        value: function (key, args, isForEmbed) {
            ...
            try {
                ...
                const embed = new EmbedBuilder()
                    .setColor(15158332)
                    .setDescription(`${emoji} ${(_a = this.client.translate(key, args, this.guild.settings.Language)) !== null && _a !== void 0 ? _a : key}`);
