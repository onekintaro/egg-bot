        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (((_a = settings.ModLogEvents) === null || _a === void 0 ? void 0 : _a.includes('TICKET')) && settings.ModLog) {
                const embed = new Embed(bot, channel.guild)
                    ...
                    .setColor(3066993)
                    .addFields({ name: channel.guild.translate('ticket/ticket-create:TICKET'), value: channel.toString() }, { name: channel.guild.translate('ticket/ticket-create:TICKET'), value: `${bot.users.cache.get(channel.name.split('-')[1])}`, inline: true }, { name: channel.guild.translate('ticket/ticket-create:TICKET'), value: ticket.fields[1].value, inline: true })
                    .setTimestamp();
