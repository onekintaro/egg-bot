...
// Dependencies
const { logger } = require('../utils'), chalk = require('chalk'), fetch = require('node-fetch'), { Client, GatewayIntentBits: FLAGS } = require('discord.js');
module.exports.run = (config) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!config.MongoDBURl) {
        ...
        yield mongoose.connect(config.MongoDBURl, { useUnifiedTopology: true, useNewUrlParser: true }).catch((err) => {
            console.log(err);
