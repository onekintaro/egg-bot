    ...
    run(bot, message, settings) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (message.args[0] == 'true' || message.args[0] == 'false') {
                ...
                try {
                    yield message.guild.updateGuild({ ModLog: message.args[0] });
                ...
                const currentFeatures = (_a = settings.ModLogEvents) !== null && _a !== void 0 ? _a : [];
                if (!message.args[1] || !features.includes(message.args[1].toUpperCase())) {
                    ...
                    try {
                        ...
                        yield message.guild.updateGuild({ ModLogEvents: currentFeatures });
                    ...
                    try {
                        for (const featues of message.args.map(args => args.toUpperCase())) {
                            if (currentFeatures.indexOf(featues.toUpperCase()) > -1)
                                currentFeatures.splice(currentFeatures.indexOf(featues.toUpperCase()), 1);
                        }
                        yield message.guild.updateGuild({ ModLogEvents: currentFeatures });
                ...
                try {
                    ...
                    yield message.guild.updateGuild({ ModLogChannel: channelID[0].id });
