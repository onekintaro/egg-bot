...
// Dependencies
const max = 100000, { EmbedBuilder, Colors, ApplicationCommandOptionType, PermissionsBitField: { Flags } } = require('discord.js'), Command = require('../../structures/Command.js');
/**
 * Random command
 * @extends {Command}
*/
  ...
  */
    run(bot, message, settings) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const num1 = parseInt(message.args[0]), num2 = parseInt(message.args[1]);
    ...
    */
    callback(bot, interaction, guild, args) {
        return __awaiter(this, void 0, void 0, function* () {
            const channel = guild.channels.cache.get(interaction.channelId), settings = guild.settings, num1 = args.get('min').value, num2 = args.get('max').value;
            // Make sure they follow correct rules
            if ((num2 < num1) || (num1 === num2) || (num2 > max) || (num1 < 0)) {
