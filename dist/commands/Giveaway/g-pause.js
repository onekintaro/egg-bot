  ...
  */
    run(bot, message, settings) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!message.args[0])
                return message.channel.error('misc:INCORRECT_FORMAT', { EXAMPLE: settings.prefix.concat(message.translate('giveaway/g-pause:USAGE')) });
            // Pause the giveaway
            const messageID = message.args[0];
            try {
                yield bot.giveawaysManager.pause(messageID);
    ...
    */
    callback(bot, interaction, guild, args) {
        return __awaiter(this, void 0, void 0, function* () {
            const channel = guild.channels.cache.get(interaction.channelId), messageID = args.get('id').value;
            // Pause the giveaway
            try {
                yield bot.giveawaysManager.pause(messageID);
