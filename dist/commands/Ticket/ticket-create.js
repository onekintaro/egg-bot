...
class TicketCreate extends Command {
    ...
    */
    run(bot, message, settings) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (message.guild.roles.cache.get(settings.TicketSupportRole))
                perms.push({ id: settings.TicketSupportRole, allow: [Flags.SendMessages, Flags.ViewChannel] });
            // create channel
            try {
                const channel = yield message.guild.channels.create(`ticket-${message.author.id}`, { type: 'text',
                    reason: reason,
                ...
                const embed = new Embed(bot, message.guild)
                    .setColor(0xFF5555)
                    .addFields({ name: message.translate('ticket/ticket-create:FIELD1', { USERNAME: message.author.tag }), value: message.translate('ticket/ticket-create:FIELDT') }, { name: message.translate('ticket/ticket-create:FIELD2'), value: reason })
                    .setTimestamp();
    ...
    */
    callback(bot, interaction, guild, args) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            const reason = (_b = (_a = args.get('reason')) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : guild.translate('misc:NO_REASON'), { settings } = guild;
            ...
            if (guild.roles.cache.get(settings.TicketSupportRole))
                perms.push({ id: settings.TicketSupportRole, allow: [Flags.SendMessages, Flags.ViewChannel] });
            // create channel
            try {
                channel = yield guild.channels.create(`ticket-${interaction.user.id}`, { type: 'text',
                    reason: reason,
                    parent: settings.TicketCategory,
                    permissionOverwrites: perms });
                // reply to user saying that channel has been created
                ...
                const embed = new Embed(bot, guild)
                    .setColor(0xFF5555)
                    .addFields({ name: guild.translate('ticket/ticket-create:FIELD1', { USERNAME: interaction.user.tag }), value: guild.translate('ticket/ticket-create:FIELDT') }, { name: guild.translate('ticket/ticket-create:FIELD2'), value: reason })
                    .setTimestamp();
