...
class Nick extends Command {
    ...
    */
    callback(bot, interaction, guild, args) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            const member = guild.members.cache.get((_b = (_a = args.get('user')) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : interaction.user.id), channel = guild.channels.cache.get(interaction.channelId), nickname = args.get('nickname').value;
            // Make sure user user does not have ADMINISTRATOR permissions
