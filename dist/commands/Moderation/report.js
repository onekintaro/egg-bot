...
class Report extends Command {
    ...
    */
    run(bot, message, settings) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((_a = settings.ModLogEvents) === null || _a === void 0 ? void 0 : _a.includes('REPORT')) {
                // Delete command for privacy
                if (message.deletable)
                    message.delete();
                // check if a user was entered
                if (!message.args[0])
                    return message.channel.error('misc:INCORRECT_FORMAT', { EXAMPLE: settings.prefix.concat(message.translate('moderation/report:USAGE')) });
                ...
                const embed = new Embed(bot, message.guild)
                    ...
                    .setColor(15158332)
                    .addFields({ name: message.translate('moderation/report:MEMBER'), value: members[0], inline: true }, { name: message.translate('moderation/report:BY'), value: message.member, inline: true }, { name: message.translate('moderation/report:IN'), value: message.channel }, { name: message.translate('moderation/report:REASON'), value: message.args.slice(1).join(' ') })
                    .setTimestamp()
    ...
    */
    callback(bot, interaction, guild, args) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const member = guild.members.cache.get(args.get('user').value), channel = guild.channels.cache.get(interaction.channelId), reason = args.get('reason').value, { settings } = guild;
            // Make sure that REPORT is in the mod logs
            if ((_a = settings.ModLogEvents) === null || _a === void 0 ? void 0 : _a.includes('REPORT')) {
                // Make sure user isn't trying to punish themselves
                ...
                const embed = new Embed(bot, guild)
                    ...
                    .setColor(15158332)
                    .addFields({ name: guild.translate('moderation/report:MEMBER'), value: member, inline: true }, { name: guild.translate('moderation/report:BY'), value: interaction.member, inline: true }, { name: guild.translate('moderation/report:IN'), value: interaction.channel }, { name: guild.translate('moderation/report:REASON'), value: reason })
                    .setTimestamp()
