...
class DM extends Command {
    ...
    */
    run(bot, message, settings) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!message.args[1])
                return message.channel.error('misc:INCORRECT_FORMAT', { EXAMPLE: settings.prefix.concat(message.translate('moderation/dm:USAGE')) });
            ...
            try {
                ...
                yield members[0].user.send({ embeds: [embed] });
    ...
    */
    callback(bot, interaction, guild, args) {
        return __awaiter(this, void 0, void 0, function* () {
            const member = guild.members.cache.get(args.get('user').value), channel = guild.channels.cache.get(interaction.channelId), text = args.get('message').value;
            // send message
            try {
                ...
                yield member.user.send({ embeds: [embed] });
