...
// Dependencies
const { image_search } = require('duckduckgo-images-api'), { Embed } = require('../../utils'), { ApplicationCommandOptionType, ChannelType, PermissionsBitField: { Flags } } = require('discord.js'), Command = require('../../structures/Command.js');
/**
 * Image command
 * @extends {Command}
*/
class Image extends Command {
    ...
    */
    run(bot, message, settings) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const results = yield image_search({ query: message.args.join(' '), moderate: (message.channel.nsfw || message.channel.type == ChannelType.DM) ? false : true, iterations: 2, retries: 2 });
                // send image
    ...
    */
    callback(bot, interaction, guild, args) {
        return __awaiter(this, void 0, void 0, function* () {
            const topic = args.get('topic').value, channel = guild.channels.cache.get(interaction.channelId);
            yield interaction.reply({ content: guild.translate('misc:GENERATING_IMAGE', { EMOJI: bot.customEmojis['loading'] }) });
            try {
                const results = yield image_search({ query: topic, moderate: (channel.nsfw || channel.type == ChannelType.DM) ? false : true, iterations: 2, retries: 2 });
