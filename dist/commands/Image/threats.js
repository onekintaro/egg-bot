    ...
    */
    run(bot, message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const json = yield fetch(encodeURI(`https://nekobot.xyz/api/imagegen?type=threats&url=${files[0]}`)).then(res => res.json());
                // send image in embed
    ...
    */
    callback(bot, interaction, guild, args) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const json = yield fetch(encodeURI(`https://nekobot.xyz/api/imagegen?type=threats&url=${member.user.displayAvatarURL({ format: 'png', size: 1024 })}`)).then(res => res.json());
